...
export default function ProductCard({ product }) {
  return (
    <div className="flex flex-col bg-white rounded-lg shadow-lg overflow-hidden transition-all duration-300 transform hover:scale-105 hover:shadow-xl">
      {/* Product Image */}
      ...
      <div className="p-3">
        ...
        <Link href={`/products/${product.id}`}>
          <button className="bg-blue-500 text-white text-xs px-3 py-1 rounded-full mt-2 hover:bg-blue-600">
            View Details
          </button>
        </Link>
      </div>
